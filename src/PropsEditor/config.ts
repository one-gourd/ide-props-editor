...
import { DEFAULT_PROPS, IPropsEditorProps } from '.';
...
export const configPropsEditor: IModuleConfig<IPropsEditorProps, ISubProps> = {
  component: {
...
// 当然也可以自己枚举
export const SELF_CONTROLLED_KEYS = Object.keys(configPropsEditor.model.props); // ['visible', 'text']
...
// 初始化 controlledKeys
configPropsEditor.model.controlledKeys = CONTROLLED_KEYS;
