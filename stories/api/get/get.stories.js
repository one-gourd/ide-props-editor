...
import { PropsEditorFactory } from '../../../src';
import { modelPropsGen } from '../../helper';

const {
  ComponentWithStore: PropsEditorWithStore1,
  client: client1
} = PropsEditorFactory();

// const {
//   PropsEditorWithStore: PropsEditorWithStore2,
//   client: client2
// } = PropsEditorFactory();
  ...
  .addWithJSX('/model 获取属性信息', () => {
    return (
      <Row style={styles.demoWrap}>
        ...
        <Col span={24}>
          <PropsEditorWithStore1 onClick={onClick} />
        </Col>
      </Row>
    );
  });